...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:oai="http://www.openarchives.org/OAI/2.0/">
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>Palib Repository: OAI-PMH 2.0 Request Results</title>
        <style><xsl:call-template name="style"/></style>
      </head>
      <body>
		<div class="page-header">
		  <div class="header-icon">
			<img src="Resources/palib_logo.png"/>
		  </div>
		  <h1 class="page-title">Request Results of OAI-PMH for Palib Repository</h1>
		</div>
		<div class="page-content">
			<xsl:call-template name="quicklinks"/>
			<xsl:apply-templates select="/oai:OAI-PMH"/>
			<xsl:call-template name="quicklinks"/>
			<p class="info">You are viewing an HTML version of the XML OAI-PMH response from Palib repository</p>
		</div>	
      </body>
    </html>
  </xsl:template>
...
<xsl:template match="dc:contributors" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">Contributors</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>

<xsl:template match="dc:supervisor" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">Supervisor</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>

<xsl:template match="dc:isPartof" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">is Part of</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>

<xsl:template match="dc:isPartofSeries" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">is Part of series</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>
...
<xsl:template match="dc:keywords" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">Keywords</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>
...
<xsl:template match="dc:date_year" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">Year</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>
...
<xsl:template match="dc:doi" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <tr><td class="key">DOI</td><td class="value"><xsl:value-of select="."/></td></tr>
</xsl:template>
